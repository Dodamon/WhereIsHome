...
<h3 style="text-align:center">글쓰기</h3>
  <form name="articleForm" method="post"   action="/board/write"   enctype="multipart/form-data">
    <input type="hidden" name="csrf_token" value="${CSRF_TOKEN }" >
    
    <table class="table table-border">
      <tr>
					<td > 작성자 : </td>
					<td colspan=2  ><input type="text" size="50" maxlength="100" id="id" name="writer" 
     ...
     <tr>
			  ...
			  <td>
					...
					<input type="file" class="form-control border" name="file" id="file" multiple="multiple">
			  </td>
	   </tr>
	   <tr>
